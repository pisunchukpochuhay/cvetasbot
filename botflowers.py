...
# Кнопки
button1 = InlineKeyboardButton(text="🌹Каталог + контакт для завказа🌹", url="https://t.me/+1tfHkcot7YxjY2Ri")
button2 = InlineKeyboardButton(text="🌸Наши отзывы, находятся в конце сайта🌸", url="http://uflor.site")
